...
<h2 class="sub-header">Reply to complaint</h2>
				...
				if(!isset($_POST["Reply"]))
                 ...
                 <div class="bs-example">
                            <p>
                              <a class="btn btn-success collapsed" data-toggle="collapse" href="#collapsePendingComplaints" aria-expanded="false" aria-controls="collapseExample">
                                Solve complaints
                              </a>
                            </p>
                            <div class="collapse" id="collapsePendingComplaints" aria-expanded="false" style="height: 0px;">
     							<div class="well">
                 ...
                 <div class="bs-example">
                            <p>
                              <a class="btn btn-default collapsed" data-toggle="collapse" href="#collapseAllComplaints" aria-expanded="false" aria-controls="collapseExample">
                                All complaints
                              </a>
                            </p>
                            <div class="collapse" id="collapseAllComplaints" aria-expanded="false" style="height: 0px;">
     							<div class="well">
                                  <div class="table-responsive">
                                    <table class="table table-striped">
                                              <thead>
											...
											global $connection;
											//select * from complaints,departments where complaints.deptid = departments.deptid;
											$query = "SELECT * FROM complaints,users where complaints.status!=\"inactive\" AND complaints.deptid=\"". $deptid ."\" GROUP BY complaintid ORDER BY date DESC";
